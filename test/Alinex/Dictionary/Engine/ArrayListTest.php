...
class ArrayListTest extends \PHPUnit_Framework_TestCase
{
    ...
    function testList()
    {
        ...
        $this->assertEquals(3, $this->object->listSet('list', null, 555));
    ...
    function testAllow()
    {
        ...
        $this->assertEquals(1, $this->object->allow(5, Engine::SCOPE_SESSION));
        $this->assertEquals(0.8, $this->object->allow(5, Engine::SCOPE_LOCAL));
        $this->assertEquals(0.5, $this->object->allow(5, Engine::SCOPE_GLOBAL));
