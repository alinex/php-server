...
class XCacheTest extends \PHPUnit_Framework_TestCase
{
    ...
    function setUp()
    {
        if (!XCache::isAvailable())
            $this->markTestSkipped('The Xcache extension have to be loaded.');
    }

    function testInitial()
    {
        $this->object = XCache::getInstance();
        $this->object->clear();
    ...
    function testEditing()
    {
        ...
        $this->assertEquals(121.1, $this->object->inc('normalValue',0.1));
        $this->assertEquals(121, $this->object->dec('normalValue',0.1));
