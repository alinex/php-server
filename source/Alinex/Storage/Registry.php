...
class Registry implements \Countable, \ArrayAccess
{
     ...
     *
     * @return \Alinex\Storage\Registry
     ...
     * engine.
     *
     * @param Engine $dataStorage place to store data entries
     * @param Engine $validatorStorage place to store validation rules
     */
    function __construct(
        Engine $dataStorage, Engine $validatorStorage = null
    )
    {
        $this->_data = $dataStorage;
        $this->_validator = $validatorStorage;
    }
    ...
    {
        $importer->setStorage($this->_data);
    ...
    {
        $importer->setStorage($this->_validator);
        return $importer->import();
    }
}
